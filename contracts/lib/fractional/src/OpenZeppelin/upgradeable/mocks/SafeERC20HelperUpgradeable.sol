...
contract SafeERC20WrapperUpgradeable is Initializable, ContextUpgradeable {
    ...
    function __SafeERC20Wrapper_init(IERC20Upgradeable token)
        internal
        initializer
    {
        __Context_init_unchained();
    ...
    function __SafeERC20Wrapper_init_unchained(IERC20Upgradeable token)
        internal
        initializer
    {
        _token = token;
    ...
    function setAllowance(uint256 allowance_) public {
        ERC20ReturnTrueMockUpgradeable(address(_token)).setAllowance(
            allowance_
        );
    }
