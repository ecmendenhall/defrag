...
contract UUPSUpgradeableMockUpgradeable is
    Initializable,
    CountersImplUpgradeable,
    UUPSUpgradeable
{
...
contract UUPSUpgradeableUnsafeMockUpgradeable is
    Initializable,
    UUPSUpgradeableMockUpgradeable
{
    ...
    function __UUPSUpgradeableUnsafeMock_init_unchained()
        internal
        initializer
    {}
...
contract UUPSUpgradeableBrokenMockUpgradeable is
    Initializable,
    UUPSUpgradeableMockUpgradeable
{
    ...
    function __UUPSUpgradeableBrokenMock_init_unchained()
        internal
        initializer
    {}
    ...
    function upgradeToAndCall(address, bytes memory)
        external
        payable
        virtual
        override
