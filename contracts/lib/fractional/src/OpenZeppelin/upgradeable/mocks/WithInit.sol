...
contract TimelockControllerUpgradeableWithInit is
...
contract MulticallTokenMockUpgradeableWithInit is
    MulticallTokenMockUpgradeable
{
...
contract ERC20PresetMinterPauserUpgradeableWithInit is
...
contract ERC1155PresetMinterPauserUpgradeableWithInit is
...
contract ERC721URIStorageMockUpgradeableWithInit is
...
contract ERC165InterfacesSupportedUpgradeableWithInit is
...
contract ERC1155ReceiverMockUpgradeableWithInit is
...
contract ERC1155PausableMockUpgradeableWithInit is
    ERC1155PausableMockUpgradeable
{
    constructor(string memory uri) public payable {
...
contract ERC1155BurnableMockUpgradeableWithInit is
    ERC1155BurnableMockUpgradeable
{
    constructor(string memory uri) public payable {
...
contract ERC721EnumerableMockUpgradeableWithInit is
    ERC721EnumerableMockUpgradeable
{
    constructor(string memory name, string memory symbol) public payable {
...
contract ERC721BurnableMockUpgradeableWithInit is
...
contract ERC721PausableMockUpgradeableWithInit is
    ERC721PausableMockUpgradeable
{
    constructor(string memory name, string memory symbol) public payable {
...
contract ERC20ReturnFalseMockUpgradeableWithInit is
...
contract ERC20ReturnTrueMockUpgradeableWithInit is
...
contract ERC777PresetFixedSupplyUpgradeableWithInit is
...
contract ERC777SenderRecipientMockUpgradeableWithInit is
    ERC777SenderRecipientMockUpgradeable
{
    constructor() public payable {
...
contract ERC1820ImplementerUpgradeableWithInit is
...
contract ERC1820ImplementerMockUpgradeableWithInit is
    ERC1820ImplementerMockUpgradeable
{
    constructor() public payable {
...
contract ERC3156FlashBorrowerMockUpgradeableWithInit is
...
contract ERC20FlashMintMockUpgradeableWithInit is
...
contract ERC20PresetFixedSupplyUpgradeableWithInit is
...
contract ERC2771ContextMockUpgradeableWithInit is
...
contract ConditionalEscrowMockUpgradeableWithInit is
    ConditionalEscrowMockUpgradeable
{
    constructor() public payable {
...
contract UUPSUpgradeableMockUpgradeableWithInit is
...
contract UUPSUpgradeableUnsafeMockUpgradeableWithInit is
...
contract UUPSUpgradeableBrokenMockUpgradeableWithInit is
...
contract SignatureCheckerMockUpgradeableWithInit is
    SignatureCheckerMockUpgradeable
{
    constructor() public payable {
...
contract ERC20VotesCompMockUpgradeableWithInit is
    ERC20VotesCompMockUpgradeable
{
    constructor(string memory name, string memory symbol) public payable {
...
contract AccessControlEnumerableMockUpgradeableWithInit is
    AccessControlEnumerableMockUpgradeable
{
    constructor() public payable {
...
contract EnumerableBytes32SetMockUpgradeableWithInit is
    EnumerableBytes32SetMockUpgradeable
{
    constructor() public payable {
...
contract EnumerableAddressSetMockUpgradeableWithInit is
    EnumerableAddressSetMockUpgradeable
{
    constructor() public payable {
...
contract EnumerableUintSetMockUpgradeableWithInit is
    EnumerableUintSetMockUpgradeable
{
    constructor() public payable {
...
contract BadBeaconNotContractUpgradeableWithInit is
...
contract ClashingImplementationUpgradeableWithInit is
...
contract DummyImplementationUpgradeableWithInit is
...
contract DummyImplementationV2UpgradeableWithInit is
...
contract ERC165NotSupportedUpgradeableWithInit is
...
contract MerkleProofWrapperUpgradeableWithInit is
...
contract SignedSafeMathMockUpgradeableWithInit is
    SignedSafeMathMockUpgradeable
{
    constructor() public payable {
